...
python3 robot_rotation_test.py <USERNAME> <PASSWORD> <START_N> 

This is a test script for the robot_rotation.py script, designed to validate the map recording and conversion process without requiring actual robot hardware. It uses MagicMock to simulate the robot's clients and responses, allowing us to test the logic of our mapping and conversion functions in isolation.
