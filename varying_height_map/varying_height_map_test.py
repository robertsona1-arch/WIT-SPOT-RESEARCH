"""
varying_height_map_test.py

python varying_height_map_test.py <USERNAME> <PASSWORD> <DIRECTORY> --end_n <END_N>

This is a test script fo the varying_height_map.py script, designed to validate the scripts function without accessing the robot hardware that the varying_height_map script runs on.
