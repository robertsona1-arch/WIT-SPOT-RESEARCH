...
mac - python3 rot_anchor.py <USERNAME> <PASSWORD> --map_dir "DIRECTORY" --mast_dir "MASTER_MAP_DIR" --dist <DISTANCE_IN_METERS> --start_n <START_N> --end_n <END_N>

windows - python rot_anchor.py <USERNAME> <PASSWORD> --map_dir "DIRECTORY" --mast_dir "MASTER_MAP_DIR" --dist <DISTANCE_IN_METERS> --start_n <START_N> --end_n <END_N>
use dist=3.5
...
from leo_funcs import check_batt_perc, turn_relative, convert_map_to_ply_3, turn_relative, nav_to_fid, upload_map, fine_align, log_test_metrics,ensure_recording_stopped
    ...
    with LeaseKeepAlive(lease_client, must_acquire=False, return_at_exit=True):
        ...
        for a in range(options.start_n, options.end_n+1):
            ...
            if 360 % a ==0:
                ...
                convert_map_to_ply_3(full_path,ply_name,a)
                end_time = time.time()
