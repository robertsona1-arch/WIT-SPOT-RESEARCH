...
# Safely inject the robust jitter calculation directly in case the leo_funcs import fails
...
def main():
    parser = argparse.ArgumentParser(description="Analyze proximity sensor bias with dual-pass primitive and global average outputs.")
    parser.add_argument('--name', default="Test 1 Proximity Impact", help="Official Test Name to replace {test name} in titles")
    ...
    plots_to_generate = [
        ...
        {'y': 'Concentration_Value', 'x': 'Time_s', 
         ...
         'fn': '02_Concentration_vs_Time.png', 'idx': 2, 'legend_loc': 'top_left'},
    ...
    env_map = {
        'standing_map_0deg': {'linestyle': '-', 'marker': 'o', 'label': 'Baseline 3.5m'},
        'closer': {'linestyle': '--', 'marker': 's', 'label': 'Closer 1.5m'}
    }
    ...
    for plot_cfg in plots_to_generate:
        ...
        elif plot_cfg['legend_loc'] == 'top_left':
    ...
    # ==========================================
    avg_color_map = {'standing_map_0deg': '#1f77b4', 'closer': '#2ca02c'}
    ...
    for plot_cfg in plots_to_generate:
        ...
        for env, group_df in combined_box_df.groupby('Test_Environment'):
            ...
            # Analytics: Safe Array Jitter extraction
