    ...
    for idx, cfg in enumerate(panel_cfgs):
        ...
        for data_key, sub_df in df_map.items():
            ...
            for env, group_df in sub_df.groupby('Test_Environment'):
                ...
                # FIXED: Will no longer throw KeyError because dictionary mapping is updated below
...
def main():
    ...
    # 1. FIXED: Target folders synchronized with filesystem name
    ...
    # 2. FIXED: Inner mapping keys updated from 'varying_height' to 'varying_height_0deg'
    style_guide = {
        'CY2': {
    ...
    print(f"\n[SUCCESS] Pipeline execution complete. 3 Composite PNG files exported to /{output_dir.name}/")
